(function () {
  ...
  const TripWorkspace = {
    setup() {
      ...
      return {trip,dashboard,stops,itinerary,budget,expenses,journals,active,dialog,editing,stopForm,itemForm,expenseForm,openStop,openItem,openExpense,saveStop,saveItem,saveExpense,remove,saveCategory,removeJournal,beginTabSwipe,endTabSwipe,router,itineraryTypeOptions,statusLabel,itineraryTypeLabel};
    },
